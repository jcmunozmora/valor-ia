...
<div class="eq-profile eq-profile--lead">
  ...
  <div class="eq-profile-body">
    ...
    <div class="eq-role">Director</div>
...
<div class="eq-profile">
  ...
  <div class="eq-profile-body">
    ...
    <div class="eq-role">Coordinadora Proyectos &mdash; Evaluacion de Impacto y Analisis de Datos</div>
...
<div class="eq-profile">
  <div class="eq-photo-wrap">
    ...
    <div class="eq-photo-badge eq-badge--indigo">Comportamiento &amp; IA</div>
  </div>
  <div class="eq-profile-body">
    <div class="eq-name">Sebastian Vasquez Lopez, Ph.D. (Oxon)</div>
    <div class="eq-role">Especialista en Ciencias del Comportamiento &mdash; Medicion, Seguimiento e Inteligencia Artificial</div>
    <div class="eq-affil">Cofundador, Two Sigma Lab &middot; Ex-investigador, University of Oxford</div>
    <p class="eq-bio">
      Ph.D. Neurociencia (Oxford, 2017). Experto en ciencias del comportamiento aplicadas a la medicion y
      el seguimiento de programas sociales: diseño de instrumentos conductuales, metricas de cambio de
      comportamiento y sistemas de monitoreo basados en evidencia experimental. Diez anos en IA aplicada
      y machine learning. Faculty AI Fellowship (Londres, 2025). Becario Clarendon (Oxford) y Colfuturo.
      Cofundo Two Sigma Lab. Publicaciones en <em>Nature Light</em> y <em>eLife</em>.
    </p>
    <div class="eq-tags-row">
      <span class="eq-tag eq-tag--indigo">Ciencias del comportamiento</span>
      <span class="eq-tag eq-tag--indigo">Medicion conductual</span>
      <span class="eq-tag eq-tag--indigo">Sistemas agenticos &middot; IA</span>
...
<!-- ============================================================
     RED DE INVESTIGADORES EAFIT
     ============================================================ -->
<div class="content-section">
<div class="content-inner">

<span class="section-label">Red academica institucional</span>
<h2 class="section-heading">Investigadores EAFIT — Escuela de Finanzas, Economia y Gobierno</h2>
<p style="font-size:0.95rem;color:#475569;line-height:1.75;max-width:780px;margin-bottom:2rem;">
  Valor·IA opera dentro del ecosistema academico del Centro Valor Publico y la Escuela de Finanzas,
  Economia y Gobierno. Esta red de investigadores aporta profundidad tematica especializada — desde
  evaluacion causal y economia del bienestar hasta gobernanza, finanzas sostenibles y paz territorial.
</p>
...
<div class="inv-grid">
  ...
  <div class="inv-card">
    <div class="inv-header">
      <div class="inv-name">Santiago Tobon</div>
      <div class="inv-badge inv-badge--teal">Director CVP</div>
    </div>
    <div class="inv-phd">Ph.D. Economia &middot; Universidad de los Andes</div>
    <div class="inv-area">Evaluacion experimental y cuasi-experimental &middot; Crimen, violencia y politica publica &middot; Metodos causales (RCT, DiD, PSM)</div>
    <div class="inv-link">Vinculacion iMEL: diseno evaluativo, validacion metodologica, seguridad y justicia</div>
  </div>

  <div class="inv-card">
    <div class="inv-header">
      <div class="inv-name">Monica Hernandez Florez</div>
      <div class="inv-badge inv-badge--blue">Equidad Social</div>
    </div>
    <div class="inv-phd">Ph.D. Economics and Public Policy &middot; University of Michigan</div>
    <div class="inv-area">Evaluacion de impacto en educacion &middot; Politicas publicas basadas en evidencia &middot; Microeconomia aplicada</div>
    <div class="inv-link">Vinculacion iMEL: auditoria metodologica de politicas sociales, diseno de indicadores educativos</div>
  </div>

  <div class="inv-card">
    <div class="inv-header">
      <div class="inv-name">Alejandro Torres Garcia</div>
      <div class="inv-badge inv-badge--green">Desarrollo</div>
    </div>
    <div class="inv-phd">Ph.D. Economia &middot; Universidad del Rosario</div>
    <div class="inv-area">Economia del desarrollo &middot; Crecimiento territorial &middot; Analisis de pobreza y desigualdad</div>
    <div class="inv-link">Vinculacion iMEL: valoracion de outcomes en programas de desarrollo economico local</div>
  </div>

  <div class="inv-card">
    <div class="inv-header">
      <div class="inv-name">Santiago Leyva</div>
      <div class="inv-badge inv-badge--purple">Gobierno</div>
    </div>
    <div class="inv-phd">Ph.D. Administracion Publica &middot; Especializacion en Gobernanza</div>
    <div class="inv-area">Gobierno y democracia &middot; Gestion publica &middot; Capacidades estatales y reforma institucional</div>
    <div class="inv-link">Vinculacion iMEL: marcos de valor publico, evaluacion de capacidades gubernamentales</div>
  </div>

  <div class="inv-card">
    <div class="inv-header">
      <div class="inv-name">Eleonora Davalos</div>
      <div class="inv-badge inv-badge--amber">Paz y DDHH</div>
    </div>
    <div class="inv-phd">Ph.D. Public Policy &middot; University of North Carolina at Charlotte</div>
    <div class="inv-area">Politicas de paz &middot; Violaciones de DDHH &middot; Evaluacion de acuerdos de paz en Colombia</div>
    <div class="inv-link">Vinculacion iMEL: evaluacion de programas de consolidacion territorial y reconciliacion</div>
  </div>

  <div class="inv-card">
    <div class="inv-header">
      <div class="inv-name">Adolfo Eslava Gomez</div>
      <div class="inv-badge inv-badge--purple">Innovacion Social</div>
    </div>
    <div class="inv-phd">Ph.D. &middot; Politica publica y gobernanza &middot; Director EAFIT Social</div>
    <div class="inv-area">Innovacion social &middot; Gobernanza publica &middot; Co-produccion de politicas con ciudadanos</div>
    <div class="inv-link">Vinculacion iMEL: enfoques participativos, sistematizacion de experiencias sociales</div>
  </div>

  <div class="inv-card">
    <div class="inv-header">
      <div class="inv-name">Lina Marcela Cortes Duran</div>
      <div class="inv-badge inv-badge--blue">Finanzas &amp; ESG</div>
    </div>
    <div class="inv-phd">Ph.D. Economia &middot; Universidad de Salamanca &mdash; <em>Cum Laude</em> &middot; Subdecana Academica FEG</div>
    <div class="inv-area">Finanzas corporativas &middot; Gobierno corporativo &middot; Econometria aplicada &middot; Analisis ESG</div>
    <div class="inv-link">Vinculacion iMEL: valoracion financiera del impacto social, analisis de riesgo ESG</div>
  </div>

  <div class="inv-card">
    <div class="inv-header">
      <div class="inv-name">Diego Restrepo-Tobon</div>
      <div class="inv-badge inv-badge--blue">Finanzas</div>
    </div>
    <div class="inv-phd">Ph.D. Economics &amp; Finance &middot; Binghamton University (SUNY) &middot; Coordinador Maestria en Finanzas</div>
    <div class="inv-area">Finanzas corporativas &middot; Eficiencia bancaria &middot; Crisis financieras &middot; Econometria aplicada &middot; Valoracion de empresas</div>
    <div class="inv-link">Vinculacion iMEL: valoracion monetaria del impacto en mercados financieros, analisis de materialidad ESG</div>
  </div>

  <div class="inv-card">
    <div class="inv-header">
      <div class="inv-name">Andres Ramirez Hassan</div>
      <div class="inv-badge inv-badge--green">Datos &amp; IA</div>
    </div>
    <div class="inv-phd">Ph.D. Estadistica &middot; Universidad Nacional de Colombia &middot; Coordinador Grupo OMEGA &middot; Postdoc Monash University</div>
    <div class="inv-area">Econometria bayesiana &middot; Machine learning &middot; Efectos causales &middot; Aplicaciones en salud, crimen y finanzas &middot; 50+ articulos indexados</div>
    <div class="inv-link">Vinculacion iMEL: modelos analiticos avanzados, validacion estadistica de outcomes, inferencia causal bayesiana</div>
  </div>

  <div class="inv-card">
    <div class="inv-header">
      <div class="inv-name">Hernan Herrera-Echeverri</div>
      <div class="inv-badge inv-badge--amber">Capital &amp; Empresa</div>
    </div>
    <div class="inv-phd">Ph.D. Administracion &middot; Universidad de los Andes &middot; Visiting researcher Florida International University</div>
    <div class="inv-area">Capital de riesgo y private equity &middot; Finanzas corporativas &middot; Gobierno corporativo &middot; Calidad institucional e inversion en economias emergentes</div>
    <div class="inv-link">Vinculacion iMEL: valoracion de programas de desarrollo empresarial, finanzas de impacto y SIBs</div>
  </div>
...
<table class="eq-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><span class="eq-role-pill" style="background:#EEF2FF;color:#4338CA;border-color:#C7D2FE;">Comportamiento &amp; IA</span></td>
      <td>Ph.D. Oxford &middot; Faculty AI</td>
      <td>Especialista en ciencias del comportamiento &middot; Medicion conductual &middot; IA aplicada</td>
    </tr>
  </tbody>
</table>
</div>
...
.inv-badge--teal   { background: #F0FDFA; color: #0D9488; border: 1px solid #CCFBF1; }
.inv-badge--blue   { background: #EFF6FF; color: #1D4ED8; border: 1px solid #BFDBFE; }
.inv-badge--purple { background: #F5F3FF; color: #7C3AED; border: 1px solid #DDD6FE; }
.inv-badge--amber  { background: #FFFBEB; color: #D97706; border: 1px solid #FDE68A; }
.inv-badge--green  { background: #F0FDF4; color: #15803D; border: 1px solid #BBF7D0; }
.inv-phd {
  font-size: .76rem;
  color: #64748B;
  margin-bottom: .55rem;
